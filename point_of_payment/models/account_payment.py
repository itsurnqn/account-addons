...
class AccountPayment(models.Model):
    ...
    def onchange_pop_session_id(self):
        if self.payment_type != 'transfer':
            self.journal_ids = self.pop_session_id.journal_ids
    ...
    def post(self):
        ...
        for rec in self:
            ...
            inbound_payment_method_codes = rec.journal_id.inbound_payment_method_ids.mapped('code')
            ...
            rec.pop_session_journal_line_id = self.env['pop.session.journal.line'].create(vals)
